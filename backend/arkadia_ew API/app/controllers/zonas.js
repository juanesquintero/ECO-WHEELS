...
routes.get('/',function(req,res){
    crud.Mongo().get('zonas',{}).then(function(respuesta){
...
routes.get('/nombre/:name',function(req,res){
    ...
    crud.Mongo().get('zonas',filtro).then(function(respuesta){
        console.log(respuesta);
        res.send(respuesta)
    }).catch(function(error){
        console.log(error)
...
routes.post('/',function(req,res){
    ...
    var body = req.body
    crud.Mongo().insert('zonas',body).then(function(respuesta){
...
routes.put('/:id',function(req,res){
    ...
    //Capturar datos a guardar
    var body = req.body
    crud.Mongo().update('zonas',filtro,body).then(function(respuesta){
...
routes.delete('/:id',function(req,res){
    ...
    //filtro 
    var filtro = { _id: id_param, }
    crud.Mongo().delete('zonas',filtro).then(function(respuesta){
