...
routes.get('/',function(req,res){
    crud.Mongo().get('reservas',{}).then(function(respuesta){
...
routes.get('/estacion/:station',function(req,res){
    ...
    crud.Mongo().get('reservas',filtro).then(function(respuesta){
        console.log(respuesta);
        res.send(respuesta)
    }).catch(function(error){
        console.log(error)
...
routes.post('/',function(req,res){
    ...
    var body = req.body
    crud.Mongo().insert('reservas',body).then(function(respuesta){
...
routes.put('/:id',function(req,res){
    ...
    //Capturar datos a guardar
    var body = req.body
    crud.Mongo().update('reservas',filtro,body).then(function(respuesta){
...
routes.delete('/:id',function(req,res){
    ...
    //filtro 
    var filtro = { _id: id_param, }
    crud.Mongo().delete('reservas',filtro).then(function(respuesta){
