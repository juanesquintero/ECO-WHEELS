...
routes.get('/',function(req,res){
    crud.Mongo().get('estaciones',{}).then(function(respuesta){
...
routes.get('/:name',function(req,res){
    ...
    crud.Mongo().get('estaciones',filtro).then(function(respuesta){
        console.log(respuesta);
        res.send(respuesta)
    }).catch(function(error){
        console.log(error)
...
routes.post('/',function(req,res){
    ...
    var body = req.body
    crud.Mongo().insert('estaciones',body).then(function(respuesta){
...
routes.put('/:id',function(req,res){
    ...
    //Capturar datos a guardar
    var body = req.body
    crud.Mongo().update('estaciones',filtro,body).then(function(respuesta){
...
routes.delete('/:id',function(req,res){
    ...
    //filtro 
    var filtro = { _id: id_param, }
    crud.Mongo().delete('estaciones',filtro).then(function(respuesta){
